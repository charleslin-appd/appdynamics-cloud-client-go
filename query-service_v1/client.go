...
// APIClient manages communication with the AppDynamics Cloud Query Service API API v1.0
...
type APIClient struct {
	...
	ExecuteQueryApi *ExecuteQueryApiService

	ResultPaginationApi *ResultPaginationApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.ExecuteQueryApi = (*ExecuteQueryApiService)(&c.common)
	c.ResultPaginationApi = (*ResultPaginationApiService)(&c.common)
